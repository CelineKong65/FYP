...
// Fetch total number of products in category 2
$stmt = $conn->prepare("SELECT COUNT(*) FROM product WHERE CategoryID = 2");
$stmt->execute();
$totalProducts = $stmt->fetchColumn();
$totalPages = ceil($totalProducts / $productsPerPage);

// Fetch products for the current page in category 2
$stmt = $conn->prepare("SELECT * FROM product WHERE CategoryID = 2 LIMIT :limit OFFSET :offset");
