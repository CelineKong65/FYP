...
// Fetch total number of active products in category 1 (Swimming)
$stmt = $conn->prepare("SELECT COUNT(*) FROM product WHERE CategoryID = 1 AND ProductStatus = 'active'");
$stmt->execute();
$totalProducts = $stmt->fetchColumn();
$totalPages = ceil($totalProducts / $productsPerPage);

// Fetch active products for the current page in category 1 (Swimming)
$stmt = $conn->prepare("SELECT * FROM product WHERE CategoryID = 1 AND ProductStatus = 'active' LIMIT :limit OFFSET :offset");
